...
export const TradeFilters: React.FC<TradeFiltersProps> = ({
  ...
  const dropdownPanel =
    'absolute left-0 right-0 top-full z-20 mt-1.5 max-h-52 min-w-full overflow-y-auto rounded-lg border border-gray-200 bg-white py-2 shadow-lg ring-1 ring-black/5';
  ...
  return (
    <div ref={dropdownsRef} className="mb-6 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      <div className="flex flex-wrap items-end gap-5">
        ...
        <div className="relative w-full min-w-[180px] sm:w-auto">
          ...
          {openDropdown === 'tags' && (
            <div className="absolute left-0 right-0 top-full z-20 mt-1.5 max-h-52 min-w-[220px] overflow-y-auto rounded-lg border border-gray-200 bg-white py-2 shadow-lg ring-1 ring-black/5">
              <button
                type="button"
